...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="icon" href="<?php echo e(asset('leoblaze.jpg')); ?>" type="image/x-icon">

        <title><?php echo e(config('app.name', 'Leoblaze')); ?></title>
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <?php echo $__env->make('layouts.landingnav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\leoblaze\revelation\resources\views/layouts/app.blade.php ENDPATH**/ ?>